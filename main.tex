...
Inorder to improve the performance of our algorithm, we modified the algorithm to only
update all the vertecies that wanted to merge with the deleted vertex after a merge was
performed. This increased the performance of our algorithm drastically however, it
therefore also lead to a worde twin-width upper bound.
\section{Results}
